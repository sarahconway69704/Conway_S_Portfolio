...
--
-- Host: localhost:8889
-- Generation Time: Dec 04, 2019 at 04:19 PM
...
INSERT INTO `tbl_work` (`ID`, `Image`, `Title`, `Description`, `Madewith`) VALUES
...
(4, 'matchstick_project.png', 'Matchstick', 'Matchstick was a group project with the goal to establish a faux advertising company and my position was Motion Designer. I created a promotional trailer for the company, highlighting the specialties of graphic design, branding, and web development. ', 'Adobe After Effects, Adobe Premiere Pro'),
